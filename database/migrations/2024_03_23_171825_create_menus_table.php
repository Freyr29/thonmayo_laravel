...
class CreateMenusTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('INSERT INTO menus VALUES(1,"Menu du midi", 1, 1, 1,"image/menu_midi.png", 13)');
        DB::statement('INSERT INTO menus VALUES(2,"Menu du plaisir", 2, 1, 2,"image/menu_plaisir.png", 14)');
        DB::statement('INSERT INTO menus VALUES(3,"Menu rapide", 1, 3, 3,"image/menu_rapide.png", 12)');
    }
