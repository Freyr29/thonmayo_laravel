...
<body style="position: fixed; top: 0;">
    <header>
        <div class="titre" style="font-family: 'Montserrat', sans-serif;">Administration - ThonMayo</div>
                ...
                <div class="text-center justify-content-center">
                    <table class="table table-dark">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="btn btn-primary" value="Modifier l'utilisateur" onclick='modify("{{ $user['email'] }}")' readonly/>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
