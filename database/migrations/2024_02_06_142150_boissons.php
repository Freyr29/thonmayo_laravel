...
class Boissons extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('INSERT INTO boissons VALUES(4, "Ice Tea", 1.76, "image/ice-tea-33cl.jpg", "Canette", 33)');
        DB::statement('INSERT INTO boissons VALUES(5, "Oasis", 1.76, "image/oasis-33cl.jpg", "Canette", 33)');
    }
    /**
